...
describe("Markdown Parser", () => {
  it("parses headings as flat top-level blocks", () => {
    const doc = parseMarkdown("# Heading 1\n\n## Heading 2\n\n### Heading 3");
    // Markdown is flat in memory too — no section wrappers. Folding is a
    // decoration layer on top of this flat doc, not a structural transform.
